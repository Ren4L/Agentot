    ...
    return(
        <div className="AboutCont" id='About'>
            ...
            <div className='AboutTextCont'>
                ...
                <div className='AboutTextOne' style={{width:'47%', marginTop:'5vw'}}>Высокий профессионализм команды и индивидуальный подход к каждому клиенту является визитной карточкой Агентства охраны труда г. Гродно.</div>
            </div>
        </div>
    )
}